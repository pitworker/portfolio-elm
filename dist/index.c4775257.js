...
*/ var _Scheduler_working = false;
    ...
    var $author$project$Main$Model = F3(function(key, route, mainContent) {
        return {
            key: key,
    ...
    var $author$project$Main$HasMainContent = function(a) {
        return {
            $: "HasMainContent",
            a: a
        };
    };
    var $author$project$Main$ContentList = F2(function(links, work) {
        return {
            links: links,
            work: work
        };
    });
    var $author$project$Main$LinkItem = F3(function(description, url, color) {
        return {
            color: color,
    ...
    var $author$project$Main$WorkItem = F6(function(id, title, description, url, thumb, color) {
        return {
            color: color,
            description: description,
            id: id,
    ...
    var $author$project$Main$contentListDecoder = A3($elm$json$Json$Decode$map2, $author$project$Main$ContentList, A2($elm$json$Json$Decode$field, "links", $elm$json$Json$Decode$list(A4($elm$json$Json$Decode$map3, $author$project$Main$LinkItem, A2($elm$json$Json$Decode$field, "description", $elm$json$Json$Decode$string), A2($elm$json$Json$Decode$field, "url", $elm$json$Json$Decode$string), A2($elm$json$Json$Decode$field, "color", $elm$json$Json$Decode$string)))), A2($elm$json$Json$Decode$field, "work", $elm$json$Json$Decode$list(A7($elm$json$Json$Decode$map6, $author$project$Main$WorkItem, A2($elm$json$Json$Decode$field, "id", $elm$json$Json$Decode$string), A2($elm$json$Json$Decode$field, "title", $elm$json$Json$Decode$string), A2($elm$json$Json$Decode$field, "description", $elm$json$Json$Decode$string), A2($elm$json$Json$Decode$field, "url", $elm$json$Json$Decode$string), A2($elm$json$Json$Decode$field, "thumb", $elm$json$Json$Decode$string), A2($elm$json$Json$Decode$field, "color", $elm$json$Json$Decode$string)))));
    ...
    var $author$project$Main$getMainContent = $elm$http$Http$get({
        expect: A2($elm$http$Http$expectJson, $author$project$Main$HasMainContent, $author$project$Main$contentListDecoder),
    ...
    var $author$project$Main$Home = {
        $: "Home"
    };
    var $author$project$Main$ShitPage = {
        $: "ShitPage"
    };
    ...
    var $elm$url$Url$Parser$query = function(_v0) {
        ...
        return $elm$url$Url$Parser$Parser(function(_v1) {
            ...
            var value = _v1.value;
            return _List_fromArray([
                A5($elm$url$Url$Parser$State, visited, unvisited, params, frag, value(queryParser(params)))
            ]);
        });
    };
    ...
    var $elm$url$Url$Parser$questionMark = F2(function(parser, queryParser) {
        return A2($elm$url$Url$Parser$slash, parser, $elm$url$Url$Parser$query(queryParser));
    });
    ...
    var $elm$url$Url$Parser$Query$custom = F2(function(key, func) {
        return $elm$url$Url$Parser$Internal$Parser(function(dict) {
            return func(A2($elm$core$Maybe$withDefault, _List_Nil, A2($elm$core$Dict$get, key, dict)));
        });
    });
    var $elm$url$Url$Parser$Query$string = function(key) {
        return A2($elm$url$Url$Parser$Query$custom, key, function(stringList) {
    ...
    var $author$project$Main$routeParser = $elm$url$Url$Parser$oneOf(_List_fromArray([
        ...
        A2($elm$url$Url$Parser$map, $author$project$Main$BlogList, A2($elm$url$Url$Parser$questionMark, $elm$url$Url$Parser$s("blog"), $elm$url$Url$Parser$Query$string("search"))),
        A2($elm$url$Url$Parser$map, $author$project$Main$BlogPost, A2($elm$url$Url$Parser$slash, $elm$url$Url$Parser$s("blog"), $elm$url$Url$Parser$int)),
        A2($elm$url$Url$Parser$map, $author$project$Main$Content, A2($elm$url$Url$Parser$slash, $elm$url$Url$Parser$s("content"), $elm$url$Url$Parser$string)),
        A2($elm$url$Url$Parser$map, $author$project$Main$ShitPage, $elm$url$Url$Parser$s("shitpage.html"))
    ]));
    var $author$project$Main$init = F3(function(_v0, url, key) {
        return _Utils_Tuple2(A3($author$project$Main$Model, key, A2($elm$url$Url$Parser$parse, $author$project$Main$routeParser, url), $author$project$Main$Loading), $author$project$Main$getMainContent);
    });
    ...
    var $author$project$Main$update = F2(function(msg, model) {
        switch(msg.$){
            ...
            default:
                var result = msg.a;
                if (result.$ === "Ok") {
                    var contentList = result.a;
                    return _Utils_Tuple2(_Utils_update(model, {
                        mainContent: $author$project$Main$Success(contentList)
                    }), $elm$core$Platform$Cmd$none);
                } else {
                    var error = result.a;
                    return _Utils_Tuple2(_Utils_update(model, {
                        mainContent: $author$project$Main$Failure(error)
                    }), $elm$core$Platform$Cmd$none);
                }
        }
    });
    var $elm$browser$Browser$Document = F2(function(title, body) {
        return {
            body: body,
            title: title
        };
    ...
    var $author$project$Main$viewHref = F2(function(url, txt) {
    ...
    var $author$project$Main$listLink = function(linkItem) {
        return A2($author$project$Main$viewHref, linkItem.url, linkItem.description);
    };
    var $author$project$Main$listWork = function(workItem) {
        return A2($author$project$Main$viewHref, "/" + workItem.id, workItem.description);
    };
    var $elm$html$Html$p = _VirtualDom_node("p");
    var $author$project$Main$viewMainContent = function(mainContent) {
        switch(mainContent.$){
            case "Failure":
                var error = mainContent.a;
                return _List_fromArray([
                    A2($elm$html$Html$h3, _List_Nil, _List_fromArray([
                        $elm$html$Html$text("Content failed to load :<")
                    ])),
                    A2($elm$html$Html$p, _List_Nil, _List_fromArray([
                        $elm$html$Html$text(function() {
                            switch(error.$){
                                ...
                                default:
                                    var str = error.a;
                                    return "Request returned bad body: " + str;
                            }
                        }())
                    ]))
                ]);
            ...
            default:
                var contentList = mainContent.a;
                return _List_fromArray([
                    A2($elm$html$Html$h2, _List_Nil, _List_fromArray([
                        $elm$html$Html$text("Links")
                    ])),
                    A2($elm$html$Html$ul, _List_Nil, A2($elm$core$List$map, $author$project$Main$listLink, contentList.links)),
                    A2($elm$html$Html$h2, _List_Nil, _List_fromArray([
                        $elm$html$Html$text("Work")
                    ])),
                    A2($elm$html$Html$ul, _List_Nil, A2($elm$core$List$map, $author$project$Main$listWork, contentList.work))
                ]);
        }
    };
    var $elm$html$Html$li = _VirtualDom_node("li");
    var $author$project$Main$viewMenuItem = function(url) {
        return A2($elm$html$Html$li, _List_Nil, _List_fromArray([
            A2($author$project$Main$viewHref, url, url)
        ]));
    };
    var $elm$html$Html$code = _VirtualDom_node("code");
    var $elm$core$Debug$toString = _Debug_toString;
    var $author$project$Main$viewRoute = function(maybeRoute) {
        if (maybeRoute.$ === "Nothing") return A2($elm$html$Html$code, _List_Nil, _List_fromArray([
            $elm$html$Html$text("Unknown URL")
        ]));
        else {
            var route = maybeRoute.a;
            return A2($elm$html$Html$code, _List_Nil, _List_fromArray([
                $elm$html$Html$text($elm$core$Debug$toString(route))
            ]));
        }
    };
    var $author$project$Main$view = function(model) {
        return A2($elm$browser$Browser$Document, "Example Page for elm/url", _List_fromArray([
            A2($elm$html$Html$div, _List_Nil, _List_fromArray([
                A2($elm$html$Html$h1, _List_Nil, _List_fromArray([
                    $elm$html$Html$text("Menu")
                ])),
                A2($elm$html$Html$ul, _List_Nil, A2($elm$core$List$map, $author$project$Main$viewMenuItem, _List_fromArray([
                    "/",
                    "/blog/",
                    "/blog/42",
                    "/blog/37",
                ...
                A2($elm$html$Html$div, _List_Nil, _List_fromArray([
                    $author$project$Main$viewRoute(model.route)
                ])),
                A2($elm$html$Html$h1, _List_Nil, _List_fromArray([
                    $elm$html$Html$text("Content")
                ])),
                A2($elm$html$Html$div, _List_Nil, $author$project$Main$viewMainContent(model.mainContent))
            ]))
        ]));
    };
